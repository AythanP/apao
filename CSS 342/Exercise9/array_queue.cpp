...
template <typename ItemType>
ArrayQueueIterator<ItemType> ArrayQueue<ItemType>::begin() {
    return ArrayQueueIterator<ItemType>(this, 0);
}

template <typename ItemType>
ArrayQueueIterator<ItemType> ArrayQueue<ItemType>::end() {
    return ArrayQueueIterator<ItemType>(this, size());
}

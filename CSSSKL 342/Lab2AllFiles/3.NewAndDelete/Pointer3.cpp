...
void dynamicAlloc1() {
	...
	*a = 3;
	cout << "value of \"*a\" is " << *a << endl;
    // the check of "a != nullptr" is unnecessary, why?
	//if (a != nullptr) {
		cout << "value of \"*a\" is " << *a << endl;
		delete a;
		a = nullptr;
	...
	// set a pointer to nullptr after usage
...
int main()
{
    ...
    // the following example is tricky and easy to cause problems
    // how to you know if if you should use "delete[] mem" or "delete mem"?
